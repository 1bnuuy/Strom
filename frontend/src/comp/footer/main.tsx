...
import { AvailablePaths } from "./var";
...
export default function Footer() {
  ...
  return (
    <>
      {isAvail && (
        <div className="border-contrast absolute bottom-0 left-1/2 z-40 flex w-11/12 -translate-x-1/2 items-center justify-between gap-3 border-t-3 px-5 py-4 max-md:flex-col">
